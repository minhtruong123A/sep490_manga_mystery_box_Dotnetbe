...
public class MongoDbContext
{
    ...
    public IMongoCollection<EmailVerification> EmailVerification =>
        _database.GetCollection<EmailVerification>("PendingEmailVerification");

    public IMongoCollection<Permission> Permissions => _database.GetCollection<Permission>("Permission");

    public IMongoCollection<PermissionRole> PermissionRoles =>
        _database.GetCollection<PermissionRole>("PermissionRole");

    public IMongoCollection<Role> Roles => _database.GetCollection<Role>("Role");

    public IMongoCollection<UseDigitalWallet> UseDigitalWallets =>
        _database.GetCollection<UseDigitalWallet>("UseDigitalWallet");
    ...
    public IMongoCollection<ProductInMangaBox> ProductInMangaBoxes =>
        _database.GetCollection<ProductInMangaBox>("ProductInMangaBox");

    public IMongoCollection<UserBox> UserBoxes => _database.GetCollection<UserBox>("UserBox");

    public IMongoCollection<UserCollection> UserCollections =>
        _database.GetCollection<UserCollection>("UserCollection");
    ...
    public IMongoCollection<TransactionHistory> TransactionHistories =>
        _database.GetCollection<TransactionHistory>("TransactionHistory");
    ...
    public IMongoCollection<DigitalPaymentSession> DigitalPaymentSessions =>
        _database.GetCollection<DigitalPaymentSession>("DigitalPaymentSession");

    public IMongoCollection<Report> Report => _database.GetCollection<Report>("Report");

    public IMongoCollection<TransactionFee> TransactionFees =>
        _database.GetCollection<TransactionFee>("TransactionFee");

    public IMongoCollection<ExchangeInfo> ExchangeInfos => _database.GetCollection<ExchangeInfo>("ExchangeInfo");

    public IMongoCollection<ExchangeProduct> ExchangeProducts =>
        _database.GetCollection<ExchangeProduct>("ExchangeProduct");

    public IMongoCollection<ExchangeSession> ExchangeSessiones =>
        _database.GetCollection<ExchangeSession>("ExchangeSession");
    ...
    public IMongoCollection<ProductFavorite> ProductFavorites =>
        _database.GetCollection<ProductFavorite>("ProductFavorite");

    public IMongoCollection<AuctionPaymentSession> AuctionPaymentSession =>
        _database.GetCollection<AuctionPaymentSession>("AuctionPaymentSession");

    public IMongoCollection<AuctionResult> AuctionResult => _database.GetCollection<AuctionResult>("AuctionResult");
    public IMongoCollection<Achievement> Achievements => _database.GetCollection<Achievement>("Achievement");

    public IMongoCollection<UserAchievement> UserAchievements =>
        _database.GetCollection<UserAchievement>("UserAchievement");

    public IMongoCollection<Reward> Rewards => _database.GetCollection<Reward>("Reward");
    public IMongoCollection<UserReward> UserRewards => _database.GetCollection<UserReward>("UserReward");

    public IMongoCollection<AuctionSession> AuctionSessions =>
        _database.GetCollection<AuctionSession>("AuctionSession");
