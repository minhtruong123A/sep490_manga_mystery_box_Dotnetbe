...
public class ReportRepository(MongoDbContext context)
    : GenericRepository<Report>(context.GetCollection<Report>("Report")), IReportRepository
{
    private readonly IMongoCollection<Product> _productCollection = context.GetCollection<Product>("Product");
    private readonly IMongoCollection<Report> _reportCollection = context.GetCollection<Report>("Report");
