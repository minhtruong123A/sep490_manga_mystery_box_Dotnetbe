...
public class PayOSService : IPayOSService
{
        ...
        string userId)
    {
        ...
        var paymentData = new PaymentData(
            ...
            description,
            items,
            "https://mangamysterybox.vercel.app/failure-payment",
            $"https://mangamysterybox.vercel.app/success-payment?userId={userId}&amount={amount}",
            expiredAt: expiredAt
        );
    ...
    {
        return await _unitOfWork.PayOSRepository.RechargeWalletAsync(orderCode, amount);
    }
